...
<head>
    ...
    <title>Mental Health and Substance Use</title>
...
<body>
    ...
    <div class="main_div">
        <div class="text_section1">
            ...
            <p class="heading">Mental Health and Substance Use</p>

            <p class="para_sec1">This dashboard summarizes data on mental health and substance use in
                Toronto. For additional data on mental health and substance use, see the
                Child and Youth Health dashboard [LINK]. For data on smoking among adults,
                see the Adult Health Behaviours and Risk Factors dashboard [link].
            </p>
            ...
            <ul>
                <li>
                    <a
                        href="https://www.publichealthontario.ca/en/Data-and-Analysis/Reproductive-and-Child-Health/Reproductive-Health">
                        Toronto Overdose Information System dashboard.</a>
                </li>
            </ul>
